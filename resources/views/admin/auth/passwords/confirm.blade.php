        ...
        <div class="col-lg-6">
            <div class="p-5">
                <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">OPT Request</h1>
                </div>
                <form class="user" action="{{ route('admin.password.VerifyOTP') }}" method="Post">
                    @csrf
                    ...
                    <div class="form-group">
                        <input name="token" type="text" class="form-control form-control-user" placeholder="OTP">
                        @error('token')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
