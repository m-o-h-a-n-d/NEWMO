...
@section('body')
    <div class="container">
        <div class="row justify-content-center">
            <h2 class="text-center  w-100" style="font-size: 40px">Create Users</h2>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-10">
                        ...
                        <form method="POST" action="{{ route('admin.users.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <span style="color: red !important; display: inline; float: none;">*</span>
                                    <select name="email_verified_at" id="email_verified_at" class="form-control @error('email_verified_at') is-invalid @enderror" required>
