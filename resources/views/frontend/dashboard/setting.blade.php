...
@section('content')
    ...
    <div class="dashboard container">
        <!-- Sidebar -->
        @include('frontend.dashboard._slider', ['setting_slide' => 'active'])
        <!-- Main Content -->
        <div class="main-content">
            ...
            <section id="settings">
                ...
                {{-- End Error POST --}}
                <h2>Settings</h2>
                <form class="settings-form" action="{{ route('frontend.dashboard.setting.update') }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="image" class="form-label" id="imageInput" accept="image/*" />
                        @error('image')
                            <strong class="text-danger"> {{ $message }} </strong>
                        @enderror
                    </div>
