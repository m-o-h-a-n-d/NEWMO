        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h2 class="h3 mb-2 text-gray-800">Admins</h2>
                                    ...
                                    <tbody>
                                        @foreach ($admins as $admin)
                                            <tr>
                                                ...
                                                <td data-order="{{ $admin->created_at->timestamp }}">
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <form action="{{ route('admin.admins.destroy', $admin->id) }}"
                                                            method="POST" id="deleteForm_{{ $admin->id }}">
                                                            @csrf
                                                            @method('DELETE')
                                                            <a href="#" class="delete-admin-btn"
                                                                data-id="{{ $admin->id }}">
                                                        ...
                                                        {{-- Block Or UnBlock --}}
                                                        @if ($admin->status == 0)
                                                            <a href="{{ route('admin.admins.BlockAdmin', $admin->id) }}"
                                                                title="Active admin">
