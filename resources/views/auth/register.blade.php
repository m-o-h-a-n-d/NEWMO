                ...
                <div class="card shadow-lg border-0 rounded-4">
                    <div class="card-body p-5">
                        ...
                        <div class="text-center mb-4">
                            ...
                            <p class="text-muted">Fill in the details to Sign Up</p>
                        </div>

                        {{-- Profile Preview --}}
                        <div id="profile-image-preview" class="text-center mb-4" style="display: none;">
                            <img id="preview-img" src="#" alt="Profile Preview" class="rounded-circle shadow"
                        ...
                        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                <label for="profile-image-upload" class="form-label">Upload Profile Image <span
                                        class="text-danger">*</span></label>
                                <label for="profile-image-upload"
                                    ...
                                    <span class="mt-2">Drop image or click to browse</span>
                                    <small class="text-muted">Only JPG, PNG, GIF allowed</small>
                            ...
                            {{-- تحت زر Register مباشرة --}}
                            <hr>
                            <div class="text-center mb-3  text-muted">Or SignUp with</div>
                            <div class="d-flex justify-content-around gap-3 m-auto w-50">
                                <a href="" class="btn rounded-circle text-white"
